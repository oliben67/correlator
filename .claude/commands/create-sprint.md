---
description: Create a new catalyst SPRINT-NNN container and register it in work-items/sprints.md
...
1. Read `.catalyst-proj/work-items/sprints.md` and list
...
2. Copy the template to
   ...
   Retrospective (blank).
3. Add a row to `.catalyst-proj/work-items/sprints.md`.
