---
description: Create a new catalyst SPIKE-NNNN work item and register it in work-items/spikes.md
argument-hint: <the question to answer> --parent STORY-NNNN|EPIC-NNNN [--timebox "1 day"]
---
...
1. Read `.catalyst-proj/work-items/spikes.md` and list
   `.catalyst-proj/work-items/spikes/` to find the highest existing
   `SPIKE-NNNN` (4-digit, zero-padded). The new ID is the next number.
2. Copy the template to
   `.catalyst-proj/work-items/spikes/SPIKE-NNNN-<short-kebab-summary>.md`
...
3. Add a row to `.catalyst-proj/work-items/spikes.md`.
