...
- **No argument**: list every supported command from
  `.catalyst-proj/CODE-OF-CONDUCT.md` §3 with a one-line purpose each,
  grouped (create-artifact commands, query/inspect commands, framework
  maintenance commands), then list every artifact/work-item type and its
