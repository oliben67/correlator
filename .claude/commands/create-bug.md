---
description: Create a new catalyst BUG-NNNNNN artifact and register it in development/bugs/bugs.md
...
1. Read `.catalyst-proj/development/bugs/bugs.md` and list
...
4. Copy `.catalyst-proj/development/bugs/templates/TEMPLATE-BUG-v1.md` to
   `.catalyst-proj/development/bugs/BUG-NNNNNN-<short-kebab-summary>.md`
...
5. Add a row for it to `.catalyst-proj/development/bugs/bugs.md` (the index —
